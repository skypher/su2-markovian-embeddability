...
\end{minipage}
\caption{Spin \(3/2\) embeddable geometry.  The three green boundary
surfaces are overlaid on the orange nonnegative-spectrum polytope.  Each
surface is obtained by setting one canonical rate to zero and uses the
other rates in \([0,8]\), while the defining cone is unbounded.  The
reduced opacity and full-width panel expose the intersections of the
three sheets.}
