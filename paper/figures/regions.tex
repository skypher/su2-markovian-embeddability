...
\addlegendentry{positive spectrum}
...
\small (c) covariantly embeddable
\end{minipage}
\caption{Spin \(3/2\).  Panels (a) and (b) are generated from exact
rational polytope vertices.  Panel (c) renders the three boundary
surfaces obtained by setting one canonical rate to zero; each displayed
surface uses rates in \([0,8]\), while the defining cone is unbounded.}
