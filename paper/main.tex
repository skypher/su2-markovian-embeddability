...
\title{Markovian embeddability of \(SU(2)\)-covariant\\
spin channels}
...
\newcommand{\shorttitle}{MARKOVIAN EMBEDDABILITY OF SU(2)-COVARIANT CHANNELS}
...
\begin{abstract}
For a fixed irreducible spin representation, we place the previously known
...
\vskip5pt
\noindent\textbf{Keywords.}\enspace \(SU(2)\)-covariant quantum channels;
...
repository}.  The version accompanying this manuscript is the tagged
\href{https://github.com/skypher/su2-markovian-embeddability/tree/v1.0.0}
{\texttt{v1.0.0} release}.
The saved
